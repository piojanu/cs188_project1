...
"""
 Data structures and other useful for implementing SearchAgents
"""


class Node:
    """
    Search tree node for graphSearch() function.

    properties:
      state: search state of this node.
      path:  sequence of actions leading to this node.
    """
